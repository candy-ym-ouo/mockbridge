...
type Context struct { Method string ;
Path string ;
...
if headers . Get ( "Content-Type" ) == "" && looksJSON ( body ) { headers . Set ( "Content-Type" , "application/json; charset=utf-8" ) ;
} ;
